...
LastEditTime: 2025-07-11 18:14:27
...
def convert_encoder():
    ...
    RKNN_MODEL=ONNX_MODEL.replace(".onnx", f"_{target_platform}_w4a16.rknn")
    DATASET="/home/ai_team/jielong/rknn-llm/examples/MiniCPM-V2.6/datasets.txt"
    QUANTIZE=False
    ...
    # pre-process config
    print('--> Config model')
    rknn.config(target_platform=target_platform, quantized_dtype='w4a16',
    ...
    ret = rknn.build(do_quantization=True, dataset=DATASET, rknn_batch_size=None)
    if ret != 0:
